...
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://spoilage-1a3d3-default-rtdb.asia-southeast1.firebasedatabase.app/'
})

def send_fruit_data(fruit_label, confidence):
    ref = db.reference('fruit_predictions')
    data = {
        'label': fruit_label,
...
while True:
    ...
    if confidence < CONF_THRESHOLD:
        ...
        send_fruit_data(label, confidence)
